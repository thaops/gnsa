...
class ApiEndpoints {
  ...
  static String flightList({bool isMySchedule = false, int pageIndex = 1, int pageSize = 10}) => "${Config.baseUrl}/flight/mobile/flights?IsMySchedule=$isMySchedule&PageIndex=$pageIndex&PageSize=$pageSize";
  ...
  static String supplyFormAllDetail({String? id}) => "${Config.baseUrl}/supplyform/get-supply-form-detail-by-flight-id-mobile?flightId=$id";
}
