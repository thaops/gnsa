...
final flightSignatureRepositoryProvider =
    Provider<FlightSignatureReponsitory>((ref) {
  return FlightSignatureReponsitoryImpl(
      ref.read(flightSignatureRemoteProvider));
});
final flightSignatureUserCaseProvider =
    Provider<FlightSignatureUserCase>((ref) {
