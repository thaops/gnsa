...
import 'package:gnsa/feature/presentation/flight_detail/presentation/view/poup_create_food.dart';
import 'package:gnsa/feature/presentation/flight_detail/presentation/widget/child_expansion.dart';
                ...
                children: [
                  ListView.builder(
                    ...
                    itemBuilder: (context, itemIndex) {
                      final supplyItem =
                          detailItems![outerIndex].items[itemIndex];
                      return ChildExpansion(
                        supplyItem: supplyItem,
                        supplyType: supplyType,
                        detailItemId: supplyItem.detailItemId,
    ...
    return InkWell(
      onTap: () => {
        showDialog(
                context: context,
                builder: (context) =>
                    PopupCreateFood(supplyFormDetailId: supplyFormDetailId))
            .then((value) {
