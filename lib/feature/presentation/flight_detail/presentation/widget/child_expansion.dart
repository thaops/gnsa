...
import 'package:gnsa/feature/presentation/flight_detail/presentation/provider/supply_from_update_provider.dart';
...
class ChildExpansion extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final confirmedQuantity =
        useState<int>(supplyItem?.additionalQuantity ?? 0);
    ...
    void _saveNote() {
      ...
      SupplyFromUpdateProvider.updateSupplyfromItemDetail(
        ...
        ref
            .read(flightDetailProviderProvider(ref.read(flightId),
                    isSkipLoading: true)
                .notifier)
            .fetchFlightDetail(ref.read(flightId), isSkipLoading: true);
      });
    }
