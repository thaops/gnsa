...
class MainActivity : FlutterActivity() {
    ...
    private fun printLogo(startY: Int): Int {
        ...
        try {
            ...
            if (bitmap != null) {
                ...
                val logoX = (PAGE_WIDTH - scaledBitmap.width) / (14/5)
    ...
    private fun printSupplyForms(data: Map<String, Any>, startY: Int): Int {
        ...
        try {
            ...
            printerManager?.drawText(header, headerX, yPosition, "simsun", 21, true, false, 0)
            yPosition += lineHeight
            printerManager?.drawText("--------------------------------------------".take(48), 0, yPosition, "simsun", 16, false, false, 0)
            yPosition += lineHeight
            ...
            supplyForms?.forEach { form ->
                ...
                printerManager?.drawText("$formIndex• $category ($className)    Status: $status".take(48), 0, yPosition, "simsun", 19, true, false, 0)
                yPosition += lineHeight
